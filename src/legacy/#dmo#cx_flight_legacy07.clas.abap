CLASS /dmo/cx_flight_legacy07 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_07',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_07',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id07 OPTIONAL
        booking_id            TYPE /dmo/booking_id07 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id07 OPTIONAL
        agency_id             TYPE /dmo/agency_id07 OPTIONAL
        customer_id           TYPE /dmo/customer_id07 OPTIONAL
        carrier_id            TYPE /dmo/carrier07-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_07-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_07-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date07 OPTIONAL
        end_date              TYPE /dmo/end_date07 OPTIONAL
        booking_date          TYPE /dmo/booking_date07 OPTIONAL
        flight_date           TYPE /dmo/flight_date07 OPTIONAL
        status                TYPE /dmo/travel_status07 OPTIONAL
        currency_code         TYPE /dmo/currency_code07 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id07,
          mv_booking_id            TYPE /dmo/booking_id07,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id07,
          mv_agency_id             TYPE /dmo/agency_id07,
          mv_customer_id           TYPE /dmo/customer_id07,
          mv_carrier_id            TYPE /dmo/carrier07-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_07-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_07-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date07,
          mv_end_date              TYPE /dmo/end_date07,
          mv_booking_date          TYPE /dmo/booking_date07,
          mv_flight_date           TYPE /dmo/flight_date07,
          mv_status                TYPE /dmo/travel_status07,
          mv_currency_code         TYPE /dmo/currency_code07,
...
CLASS /dmo/cx_flight_legacy07 IMPLEMENTATION.
