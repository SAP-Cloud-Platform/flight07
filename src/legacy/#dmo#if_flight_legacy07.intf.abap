...
INTERFACE /dmo/if_flight_legacy07
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL07
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel07     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING07
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking07    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_07
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_07 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT07
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight07 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id07.
  ...
  TYPES booking_id TYPE /dmo/booking_id07.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id07.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL07, /DMO/BOOKING07, /DMO/BOOK_SUP_07 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code07.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code07,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status07,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel07_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id07.
  INCLUDE TYPE /dmo/booking07_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id07.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id07.
  INCLUDE TYPE /dmo/book_sup_07_data.
